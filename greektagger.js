...
var filename_reports,filename_incomings,filename_users,filename_support,filename_commands_attack,
filename_status_upload,filename_history_upload,filename_troops_home
...
function getInterface(){
    ...
    <div id="div_container" class="ui-widget-content div_remove" style="width:600px;background-color:${backgroundColor};cursor:move;z-index:50;">
        <div   style="position:relative;top:10px;left: 560px;display:flex">
            <div id="minimize_page" style="background-color:white;margin-right:10px"><a href="#"><img src="https://img.icons8.com/material-outlined/16/000000/collapse.png"/></a></div>
            <div  class="close-btn"   ><a href="#" onclick="closeWindow()"><b><font color="${titleColor}">X</font></b></a></div>
        </div>
        
        <h2><center style="margin:10px;"><u><font color="${titleColor}">Upload data</font></u></center></h2>
        <div id="page_support" style="position:relative;top:-35px;left: 20px"   ><a href="#" onclick="viewSupport() "><img src="https://img.icons8.com/officel/30/000000/long-arrow-right.png"/></a></div>
        ...
        <div id="div_minimize">
            <table id="table_upload" class="" border="1" style="width: 100%;background-color:${backgroundColor};border-color:${borderColor}">
                <tr>
                    <td  style="text-align:center; width:auto; background-color:${headerColor}">
                        <h2><center style="margin:10px"><u><font color="${titleColor}">reports</font></u></center></h2>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                        <center style="margin:10px"><u><input class="btn" type="button" id="upload_reports" onclick="uploadReports()" value="Upload"></center>
                    ...
                    <tr>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                        <h2><center style="margin:10px"><u><font color="${titleColor}">incomings</font></u></center></h2>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                            <center style="margin:10px"><u><input class="btn" type="button" id="upload_incomings" onclick="uploadIncomings()" value="Upload"></center>
                    </td>
                        <td style="text-align:center; width:auto; background-color:${headerColor}">
                ...
                <tr>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                        <h2><center style="margin:10px"><u><font color="${titleColor}">Commands</font></u></center></h2>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                            <center style="margin:10px"><u><input class="btn" type="button" onclick="uploadSupports()" value="Upload"></center>    
                    </td>
                        <td style="text-align:center; width:auto; background-color:${headerColor}">
                ...
                <tr>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                        <h2><center style="margin:10px"><u><font color="${titleColor}">All info</font></u></center></h2>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                            <center style="margin:10px"><u><input class="btn" type="button" onclick="uploadAll()" value="Upload all"></center>    
                    </td>
                        <td style="text-align:center; width:auto; background-color:${headerColor}">
            ...
            <h2><center style="margin:10px"><u><font color="${titleColor}">Search reports</font></u></center></h2>
            <table id="table_upload" class="" border="1" style="width: 100%;background-color:${backgroundColor};border-color:${borderColor}">
                <tr>
                    <td  style="text-align:center; width:auto; background-color:${headerColor}">
                        <center style="margin:10px"><u><input class="btn" type="button" onclick="loadReports()" value="Load reports"></center> 
                        <center style="margin:10px"><u><input class="btn" type="button" onclick="databaseDetails()" value="Database details"></center> 
                    </td>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                    <center style="margin:10px"><u><input style="text-align: center;" type="text" id="input_search" onclick="" placeholder="coord" ></center> 
                    </td>
                        <td style="text-align:center; width:auto; background-color:${headerColor}">
                ...
                <tr >
                    <td  style="text-align:center; width:auto; background-color:${headerColor}">
                        <center style="margin:10px"><u><input class="btn" id="btn_off_coord" type="button" value="off coords"></center> 
                    </td>
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                        <center style="margin:10px"><u><input class="btn" id="btn_def_coord" type="button" value="def coords"></center> 
                    </td>      
                    <td style="text-align:center; width:auto; background-color:${headerColor}">
                        <center style="margin:10px"><u><input class="btn" id="btn_stack_coord" type="button" value="stacked coords"></center> 
                        <center style="margin:10px"><u><input style="text-align: center;" type="text" id="input_stacked" onclick="" placeholder="nr stack" ></center> 
                    </td>    
                </tr>        
            </table>
            <center style="margin:10px"><div id="report_view" style="background-color:#d2c09e"> report view <div><center>
        </div>
    </div>
    `;
    ...
    if(document.getElementById("incomings_table")==null){
        ...
        if(new Date("04-24-2024").getTime() < new Date().getTime()){
            $("#updateInfo").hide()
        }
    }
}
...
function testLoadReports(){
    $("#input_search").on("input",function(){
        if(loadReportsOk==false)
            UI.ErrorMessage("upload reports first","fast")
    })
...
async function uploadAll(){
    ...
    let totalTime = resultReportsResult.totalTimeUpload + resultIncomingsResult.totalTimeUpload + uploadSupportsResult.totalTimeUpload
    totalTime =  Math.round((totalTime) * 100) / 100
    document.getElementById("progress_all").innerText = `Finished in ${totalTime} s`;

    UI.SuccessMessage(`Upload all info done <br> 
...
async function uploadReports(){
    ...
    var [list_href, mapVillage]=await Promise.all([getLinks(true,map_history_upload),getInfoVillages() ]).catch(err=>{alert(err)})
            ...
            else
            {
                ...
                Array.from(map_dropbox.keys()).forEach(key=>{
                    try {
                        ...
                        let obj_village=mapVillage.get(key)
                ...
                if(result=="succes"){
                    ...
                    UI.SuccessMessage(`Upload reports done <br> 
...
function getIncomings(){
    return new Promise( (resolve,reject)=>{
        if($('[id="incomings_amount"]:visible').length == 0){
            ...
            let data = httpGet(incomings_href);
            const parser = new DOMParser();
...
async function uploadIncomings(){
    ...
    return new Promise(async(resolve,reject)=>{
        ...
        if(result=="succes"){
            let timeStopUpload = new Date().getTime();
            let totalTimeUpload =  Math.round(((timeStopUpload - timeStartUpload) / 1000) * 100) / 100
            UI.SuccessMessage(`Upload incomings done <br>
                                Upload time: <b>${totalTimeUpload} sec</b>  <br>
...
function readFileDropbox2(filename){
    return new Promise((resolve,reject)=>{
        $.ajax({
            url: "https://content.dropboxapi.com/2/files/download",
            method: 'POST',
...
async function moreInfo(){
    ...
    if(document.getElementsByClassName("info").length>0){
        ...
        for(let i=1;i<table.length-1;i++){
            ...
            let commandId=table[i].getElementsByClassName("quickedit")[0].getAttribute("data-id")
        ...
        for(let i=1;i<table.length-1;i++){
            ...
            let commandId=list_coord_player[i-1].commandId
...
async function tagIncomings(){
    ...
    for(let i=0;i<table_incomings.length;i++){
        ...
        let sizeAttack=table_incomings[i].children[13].innerText;
...
async function loadReports(){
    ...
    UI.SuccessMessage("load reports")
...
function eventGetTroops(){
    ...
    $(".load_troops").on("click",function(event){
        ...
        let nr_attacks=this.getAttribute("data-nr")
        ...
        $.get(link_home_troops,function(response){
            ...
            $.get(link_coming_troops,function(data){
                ...
                html+=`
                    ...
                    <td rowspan="3" class="" style="width:70px;height:30px;text-align:center; background-color:${headerColor};color:white">${nr_attacks}</td>
...
//////////////////////////////////////////////////////get data from /map/player.txt and /mapvillage.txt/////////////////////////////////////
...
function getCommandsGoing(){
    ...
    let datePage = httpGet(linkCommand)
    const parser = new DOMParser();
    const htmlDoc = parser.parseFromString(datePage, 'text/html'); 
...
function getSupportsAndAttacks(){
    return new Promise( (resolve,reject)=>{
        ...
        let datePage = httpGet(incomings_href)
        const parser = new DOMParser();
        const htmlDoc = parser.parseFromString(datePage, 'text/html'); 
    ...
    ///////////////////////////////////////////////////////////ignored attacks/support////////////////////////////////////////
        ...
        console.log("currentLink")
        console.log(incomings_href)
        let datePage2 = httpGet(incomings_href)
...
async function uploadSupports(){
    ...
    return new Promise(async(resolve,reject)=>{
        ...
        // console.log("why is not working?????? --- a year later: i really hope i fixed it :))")
        // console.log(map_support_dropbox)
        ...
        if(result_Status=="succes"){
            ...
            let timeStopUpload = new Date().getTime();
            let totalTimeUpload =  Math.round(((timeStopUpload - timeStartUpload) / 1000) * 100) / 100
            UI.SuccessMessage(`Upload commands done <br> 
...
async function viewSupport(){
    ...
    ///////////////////////////////////////////////////////////////////main table//////////////////////////////////////////////////////////
    let html_info=`
        <div id="div_container_view" class="ui-widget-content div_remove" style="width:900px;height:auto;background-color:${backgroundColor};cursor:move;z-index:50;">

        <div   style="position:relative;top:10px;left: 800px;display:flex;align-items: center;justify-content: center;background-color:${backgroundColor};width:100px;height:30px">
            <div id="minimize_page" style="background-color:white;margin-right:10px"><a href="#"><img src="https://img.icons8.com/material-outlined/16/000000/collapse.png"/></a></div>
            <div  class="close-btn"   ><a href="#" onclick="closeWindow()"><b><font color="${titleColor}">X</font></b></a></div>
        </div>
        
        <h2 class="div_minimize" ><center style="margin:10px;"><u><font color="${titleColor}">Upload data</font></u></center></h2>
        
        <div class="div_minimize" style="position:relative;top:-35px;left: 20px"   ><a href="#" onclick="viewSupport()" id="page_main" ><img src="https://img.icons8.com/officel/30/000000/long-arrow-left.png"/></a></div>
                
        
        <div class="div_minimize">
            ...
            <div style="display:flex;justify-content: center;width:100%">
                ...
                <div style="width: 45%;margin:15px" >
                    <table id="table_select_info"  border="1" style="width: 100%;background-color:${backgroundColor};border-color:${borderColor};" hidden>
                        <tr>
                            <td style="text-align:center; width:auto; background-color:${headerColor};text-align:left">
                                <input style="margin:5px" type="radio" id="radio_offensive" name="type_info" value="offensive_info">
                                <label for="radio_offensive" style="color:${titleColor};text-align:left;margin:5px">Enemy Info</label><br>
                                <input style="margin:5px" type="radio" class="remove_radio_def" id="radio_defensive" name="type_info" value="defensive_info" >
                                <label for="radio_defensive" class="remove_radio_def" style="color:${titleColor};text-align:left;margin:5px">Ally Info</label><br>
                            ...
                            <td style="text-align:center; width:auto; background-color:${headerColor}">
                                <center><input class="btn evt-confirm-btn btn-confirm-yes" type="button" id="btn_show_info" style="margin:10px" value="show"></center>
                            </td>                        
                        </tr>
   ...
   ////////////////////////////////////// //delete/////////////////////////////////////////////////////////////////////
    ...
    document.getElementById("page_main").addEventListener("click",()=>{
        $("#div_container_view").remove()
        $("#contentContainer").eq(0).prepend(html);
        $("#mobileContent").eq(0).prepend(html);
    ...
    document.getElementById("minimize_page").addEventListener("click",()=>{
        // $("#div_minimize").toggle(500)

        if($('.div_minimize:visible').length){
            $('.div_minimize').hide();
            $("#div_container_view").css({
                'width' : '0px',
    ...
    var [mapVillage, map_reports,map_incomings,data_support,map_attacks,map_status,map_history_upload,status_chart]=await Promise.all([
            getInfoVillages(), 
            readFileDropbox(filename_reports),
            readFileDropbox(filename_incomings),
            readFileDropbox(filename_support),
        ...
        var [map_reports, map_incomings, map_attacks, map_status, map_history_upload, data_support] = await Promise.all([
    ...
    Array.from(map_coming.keys()).forEach(key=>{
        try {
            let obj_output={}
            let playerId=mapVillage.get(key).playerId
            // console.log(playerId)
            let villageId=mapVillage.get(key).villageId
            let playerName=mapVillage.get(key).playerName
            
            let list_coming=map_coming.get(key)
            let hasAttacks=false
            let nr_attacks=0,nr_supports=0,nr_nobles=0;
            ...
            if(tribemates.includes(playerName.toLowerCase())){
                ...
                for(let i=0;i<list_coming.length;i++){
                    ...
                    if(landing_time>date_current){
                        ...
                        if(list_coming[i].labelName.includes("snob")){
                            ...
                            if(snipe==false && nr_nobles>=4){
                                recap=true
                            }
                            //check if it recaped buy someone from your tribe
                            if(snipe==false && nr_nobles>=4 && tribemates.includes(list_coming[i].player_origin_name)){
                                recaped=true
                            }
                        }
                    }
                ...
                let nr_snipe=(snipe==true)?1:0
                let nr_sniped=(sniped==true)?1:0
                let nr_recap=(recap==true)?1:0
                let nr_recaped=(recaped==true)?1:0

                obj_output.coord_destination_id=villageId
                obj_output.list_coming=list_coming

                obj_output.nr_attacks=nr_attacks

                obj_output.nr_supports=nr_supports
                obj_output.nr_nobles=nr_nobles
                
                obj_output.nr_snipe=nr_snipe
                obj_output.nr_sniped=nr_sniped
                obj_output.nr_recap=nr_recap
                obj_output.nr_recaped=nr_recaped
                // console.log("for real: "+nr_attacks)
                // console.log("hope so: "+obj_output.nr_attacks)
                // console.log(obj_output)
                // console.log("status snipe/recap")
                // console.log(key)
                // console.log(nr_snipe,nr_sniped,nr_recap,nr_recaped)

                if(!map_playerId.has(playerId) && (nr_attacks>0 || nr_supports>0)){
                    map_playerId.set(playerId,{
                        nr_attacks_total:nr_attacks,
                        nr_supports_total:nr_supports,
                        nr_nobles_total:nr_nobles,
                        list_coords:[obj_output],
                        player_destination_name:playerName,
                        player_destination_id:playerId,
                        nr_snipe_total:nr_snipe,
                        nr_sniped_total:nr_sniped,
                        nr_recap_total:nr_recap,
                        nr_recaped_total:nr_recaped
                    })
                }
                else{
                    ...
                    obj_update.nr_attacks_total+=nr_attacks
                    obj_update.nr_supports_total+=nr_supports
                    obj_update.nr_nobles_total+=nr_nobles
                    obj_update.nr_snipe_total+=nr_snipe,
                    obj_update.nr_sniped_total+=nr_sniped,
                    obj_update.nr_recap_total+=nr_recap,
                    obj_update.nr_recaped_total+=nr_recaped
    ...
    Array.from(map_playerId.keys()).forEach(key=>{
        ...
        obj.list_coords.sort((o1,o2)=>{
            return (o1.nr_attacks>o2.nr_attacks)?-1:(o1.nr_attacks<o2.nr_attacks)?1:0
        })
        map_playerId.set(key,obj)
    })


    //keep only my own villages for non admin users
    let userName = game_data.player.name.toLowerCase()
    let permission =permissions[userName]
    if(permission == "false"){
        Array.from(map_playerId.keys()).forEach(key=>{
    ...
    /////////////////////////////////////////////////////////////////////////////////players table//////////////////////////////////////////////////////////
    createTablePlayers(map_playerId,mapVillage)
    sortInfoIncomings(map_playerId,mapVillage)
    ...
    $("#input_search").on("input",(event)=>{
        ...
        if(text_input.value!=undefined){
            if(text_input.value.match(/\d+\|\d+/)!=null){
                ...
                // console.log(coord)
                let playerId=mapVillage.get(coord).playerId
                let villageId=mapVillage.get(coord).villageId
    ...
    Array.from(map_reports.keys()).forEach(key=>{
        ...
        try {//if a village become a barb
            ...
            let villageId=mapVillage.get(key).villageId
            let player_destination_name=mapVillage.get(key).playerName
            let player_destination_id=mapVillage.get(key).playerId
        ...
        for(let i=0;i<list_coords.length;i++){
            ...
            for(let j=0;j<list_coming.length;j++){
                if(list_coming[j].type_attack.includes("support")){
                    ...
                    // list_coords[i].nr_attacks = list_coords[i].nr_attacks-1 // eliminate fakes
                }
            }
            ...
            obj_result.nr_attacks=list_coords[i].nr_attacks
            obj_result.nr_nobles=list_coords[i].nr_nobles

            obj_result.nr_snipe=list_coords[i].nr_snipe
            obj_result.nr_sniped=list_coords[i].nr_sniped
            
            obj_result.nr_recap=list_coords[i].nr_recap
            obj_result.nr_recaped=list_coords[i].nr_recaped
    ...
    $("input[name='type_info']").on("click",()=>{
        console.log("load radio")
        let radio_select=$("input[name='type_info']:checked").val()
        //clear options and add 'all' option
        $("#select_player").find("option").remove()
        $('#select_player').append($('<option>', {
            value: "all",
            text: "all"
        }));  

        if(radio_select=="defensive_info"){
            Array.from(map_playerId.keys()).forEach(key=>{
                $('#select_player').append($('<option>', {
                    value: key,
                    text: map_playerId.get(key).player_destination_name
                }));                  
            })
        }
        else if(radio_select=="offensive_info"){//Enemy Info
            Array.from(mapAttacksPlayersId.keys()).forEach(key=>{
                $('#select_player').append($('<option>', {
                    value: key,
                    text: mapAttacksPlayersId.get(key)
                }));                  
            })       
        }

    })
    $("input[name='type_info']:checked").click()
    ...
    document.getElementById("btn_show_info").addEventListener("click",()=>{
        ...
        let radio_select=$("input[name='type_info']:checked").val()
        if(!radio_select){
            UI.errorMessage("Select Enemy Info",2000)
        }
        //filter information
        
        if(radio_select=="offensive_info" ){
            console.log("mapAttacksVillageId",mapAttacksVillageId)
            let drawInfo=true
            ...
            TWMap.mapHandler.spawnSector = function (data, sector) {
                ...
                let value_option=document.getElementById("select_player").value
                console.log(`call`,value_option)
                let radio_select_inside=$("input[name='type_info']:checked").val()

                if(drawInfo==true && radio_select_inside=="offensive_info"){
                    drawInfo=false
                    window.setTimeout(() => {
                                ...
                                if(villageId!=null){
                                    if(mapAttacksVillageId.has(villageId[0])){
                                        ...
                                        if(value_option=="all"){
                                            ...
                                            let obj=mapAttacksVillageId.get(villageId[0])
                                            if(obj.player_destination_id==value_option){
                                                createMapInfoOffensiveSmall(obj)
                                                console.log("draw offensive only for 1 player")
        ...
        else if(radio_select=="defensive_info"){
            ...
            TWMap.mapHandler.spawnSector = function (data, sector) {
                ...
                if(drawInfo==true && radio_select_inside=="defensive_info"){
                    drawInfo=false
                    window.setTimeout(() => {
                                ...
                                if(villageId!=null){
                                    if(mapVillageById.has(villageId[0])){
                                        ...
                                        if(value_option=="all"){
                                            ...
                                            console.log("draw defensive for every player")
                                        }
                                        else{
                                            let obj=mapVillageById.get(villageId[0])
                                            if(obj.playerId==value_option){
                                                createMapInfoDefensiveSmall(obj)
                                                console.log("draw defensive only for 1 player")
    ...
    createTableGetCoords(mapVillage)
    ...
    ////delete
    // $("#table_view").hide()
    // let table = $("#div_upload_time tr")
    // for(let i=0;i<table.length;i++){
    //     $(table[i]).find("td").last().hide()  
    // }
...
function createMapInfoDefensiveSmall(obj){
    ...
    try {
        if(document.getElementById(`info_extra${obj.villageId}`)==null && obj.nr_attacks>0){
        let greenColor="#026440"//green
        let redColor="#E80000"//red
        let blueLightColor ="#157de5";//blueLightColor
        let purpleColor="#a06a34"
        ...
        if(obj.nr_recap==1)
            colorBorder=`background-color:rgba(0, 10, 255, 0.14);outline:rgba(0, 10, 255, 0.7) solid 1px`// blue border
        
        if(obj.nr_sniped==1 || obj.nr_recaped==1)
        ...
        let html_info=`
        <img style="position:absolute;left:${leftImg};top:${topImg};width:14px;height:14px;z-index:4;margin-left:7px;"  src="https://dsen.innogamescdn.com/asset/c2dee33a/graphic//map/incoming_attack.png">
        <center><font color="${greenColor}"  class="shadow20" style="position:absolute;left:${leftImg};top:${topImg};width:14px;height:14px;z-index:4;margin-left:18px; font-size: 12px">${obj.nr_attacks}</font></center>
        <center><font color="${blueLightColor}" class="shadow20" style="position:absolute;left:${leftImg};top:${topImg};width:35px;height:15px;z-index:4;margin-top:22px;font-size: 12px">${obj.pop}k</font></center>
        <div id="info_extra${obj.villageId}" style="position:absolute;left:${leftImg};top:${topImg};width:51px;height:36px;z-index:3; ${colorBorder}">
        </div>
        `
        if(obj.nr_nobles>0){
            html_info+=`
            <center><font color="${redColor}"  class="shadow20" style="position:absolute;left:${leftImg};top:${topImg};width:14px;height:14px;z-index:4;margin-left:34px; font-size: 12px">${obj.nr_nobles}</font></center>`
        }
        if(obj.wallLevel<20){
            html_info+=`
            <center><font color="${purpleColor}" class="shadow20" style="position:absolute;left:${leftImg};top:${topImg};width:14px;height:14px;z-index:4;margin-top:22px;margin-left:34px;font-size: 12px;">${obj.wallLevel}</font></center>`
        }
...
function createMapInfoOffensiveSmall(obj){
    ...
    try {
        if(document.getElementById(`info_extra${obj.villageId}`) == null ){
            ...
            let blueBorder=`background-color:rgba(0, 10, 255, 0.14);outline:rgba(0, 10, 255, 0.7) solid 1px`// blue border
            let colorBorder="background-color:rgba(20, 20, 20, 0.34)"//no border
            ...
            if(obj.nr_nukes>0 || obj.nr_nobles>0 || obj.nr_fangs >0 ){
                if(obj.type_village!=null){
                    let border= (has_noble==true)?"background-color:rgb(255,255,0)":colorTypeAttack
                    let borderMain=(obj.type_village=="light")?blueBorder:redBorder
                    html_info=`
                ...
                if(obj.nr_nobles>0){
                    html_info+=`
                    <center><font color="${redColor}" class="shadow20" style="position:absolute;left:${leftImg};top:${topImg};width:14px;height:14px;z-index:4;margin-top:22px;margin-left:34px;font-size: 12px;background-color:black;">${obj.nr_nobles}</font></center>`
                }
...
function createTablePlayers(map_playerId,mapVillage){
    ...
    // green: '#4dff4d'
        ...
        for(let i=0;i<list_coords.length;i++){
            ...
            console.log(list_coords[i].nr_attacks)
            if(list_coords[i].nr_attacks>0 || list_coords[i].nr_supports>0){//show attacks and supports, i might delete supports
                counterVillage++

                let headColorSnipe=(obj.nr_sniped==1)?"#4dff4d":(obj.nr_snipe==1)?"#ff8080":headerColor
                let headColorRecap=(obj.nr_recaped==1)?"#4dff4d":(obj.nr_recap==1)?"#ff8080":headerColor
                ...
                <tr>
                    ...
                    <td style="text-align:center; width:auto; background-color:${headerColorPlayers}">
                        <center style="margin:0px;font-size:16px"><font color="${titleColor}"><img src="https://dsen.innogamescdn.com/asset/4ba99e83/graphic/unit/att.png">(${obj.nr_attacks})</font></center>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${headerColorPlayers}">
                    ...
                    <td style="text-align:center; width:auto; background-color:${headerColorPlayers}">
                        <center style="margin:2px;font-size:16px"><font color="${titleColor}"><img src="https://dsen.innogamescdn.com/asset/a9e85669/graphic/command/snob.png">(${obj.nr_nobles})</font></center>
                    </td>
        ...
        if(document.getElementById(`table_player${numberTr}`)!=null){
            ...
            createEventCoord(map_playerId,mapVillage,playerId)
...
function createTableCoordTroops(obj,admin){
    ...
    /////////////////////////////////////////////////////////////////////////////Add info village//////////////////////////////////////////////////
        ...
        html_table_coord+=`
            ...
            <td rowspan="3" class="" style="width:70px;height:30px;text-align:center; background-color:${headerColorCoords};color:white">${obj.nr_attacks}</td>
...
function createEventCoord(map_playerId,mapVillage,playerId){
    $(".infoCoord").on("click",(event)=>{
        ...
        html_table_coord+=createTableCoordIncomings(obj.list_coming,mapVillage)
...
function createTableCoordIncomings(list,mapVillage){
    let serverTime=document.getElementById("serverTime").innerText
    let serverDate=document.getElementById("serverDate").innerText.split("/")
    serverDate=serverDate[1]+"/"+serverDate[0]+"/"+serverDate[2]
    let date_current=new Date(serverDate+" "+serverTime).getTime()
    ...
    let html_incomings=`
        ...
        for(let i=0;i<list.length;i++){
            ...
            // console.log(list[i])
            let labelName
            let villageId=mapVillage.get(list[i].coord_destination).villageId
            let playerId=mapVillage.get(list[i].coord_destination).playerId
            let playerName=mapVillage.get(list[i].coord_destination).playerName
...
function createTableSettings(){
    ...
    //save settings
    $("#div_settings input[type=checkbox],#div_settings input[type=number], input[name='type_info']").on("mouseup input",()=>{
        console.log("save")
        let list_checkbox=[]
        let list_input=[]
        //save checkbox
...
function createTableRankingAttackers(map_ranking){
    ...
    Array.from(map_ranking.keys()).forEach((key,index)=>{
        ...
        html+=`
            <tr>
                ...
                <td style="text-align:left; width:auto; background-color:${headerColor}" >
                    <center><font style="margin:0px" color="${titleColor}">${obj_attacks.nr_nobles}</font></center>
                </td>
            </tr>
    ...
    $("#sort_nobles_att").on("click",()=>{
        map_ranking = new Map([...map_ranking.entries()].sort((o1,o2)=>{
            return (o1[1].nr_nobles>o2[1].nr_nobles)?-1:(o1[1].nr_nobles<o2[1].nr_nobles)?1:0
        }))
    ...
    Array.from(map_upload_time.keys()).forEach((key,index)=>{
        ...
        html+=`
            <tr>
                ...
                <td style="text-align:left; width:auto; background-color:${headerColor}" >
                    <center><font style="margin:0px" color="${titleColor}">${parseDate(obj_upload.report_date)}</font></center>
                </td>
                <td style="text-align:left; width:auto; background-color:${headerColor}" >
                    <center><font style="margin:0px" color="${titleColor}">${parseDate(obj_upload.incoming_date)}</font></center>
                </td>
                <td style="text-align:left; width:auto; background-color:${headerColor}" >
                    <center><font style="margin:0px" color="${titleColor}">${parseDate(obj_upload.command_date)}</font></center>
                </td>
            </tr>
...
function sortInfoIncomings(map_playerId,mapVillage){
    //////////////////////////////////////////////////////////////sort by attacks///////////////////////////////////////////
    ...
    document.getElementById("sort_by_nobles").addEventListener("click",()=>{
        ...
        Array.from(map_playerId.keys()).forEach(key=>{
            let obj=map_playerId.get(key)
            obj.list_coords.sort((o1,o2)=>{
                return (o1.nr_nobles>o2.nr_nobles)?-1:(o1.nr_nobles<o2.nr_nobles)?1:0
            })
            map_playerId.set(key,obj)
        })
        document.getElementById("tbody_player").remove()
    ...
    document.getElementById("sort_by_snipes").addEventListener("click",()=>{
        ...
        Array.from(map_playerId.keys()).forEach(key=>{
            let obj=map_playerId.get(key)
            obj.list_coords.sort((o1,o2)=>{
                return (o1.nr_snipe>o2.nr_snipe)?-1:(o1.nr_snipe<o2.nr_snipe)?1:(o1.nr_sniped>o2.nr_sniped)?-1:(o1.nr_sniped<o2.nr_sniped)?1:0;
            })
            map_playerId.set(key,obj)
        })
        document.getElementById("tbody_player").remove()
    ...
    document.getElementById("sort_by_recaps").addEventListener("click",()=>{
        ...
        Array.from(map_playerId.keys()).forEach(key=>{
            let obj=map_playerId.get(key)
            obj.list_coords.sort((o1,o2)=>{
                return (o1.nr_recap>o2.nr_recap)?-1:(o1.nr_recap<o2.nr_recap)?1:(o1.nr_recaped>o2.nr_recaped)?-1:(o1.nr_recaped<o2.nr_recaped)?1:0
            })
            map_playerId.set(key,obj)
        })
        document.getElementById("tbody_player").remove()
...
/////////////////////////////////////////////////////////////////create table for settings//////////////////////////////////////////////////////
function createTableGetCoords(mapVillage){
    let html_table=`
    <center>
    ...
    return new Promise((resolve,reject)=>{
        ...
        if (localStorage.getItem(game_data.world+"nameTroops") !== null) {
            ...
            resolve(obj)
                ...
                let currentHtml=document.body.innerHTML
                document.body.innerHTML = httpGet(game_data.link_base_pure+"place") //go to rally point
