    ...
    Array.from(map_playerId.keys()).forEach(key=>{
        ...
        `<tr>
            ...
            <td style="text-align:center; width:40px; background-color:${headerColor}">
                <a href="#"  ><center style="margin:5px"><font color="${titleColor}"><img player-id="${key}" number-tr="${counterPlayer}" class="infoPlayer" src="https://img.icons8.com/clouds/30/000000/more.png
                "/></font></center></a>
            </td>
            <td style="text-align:center; width:auto; background-color:${headerColor}">
